...
{
	string freePos = "";			// part of freeMap, containing only the starting positions of the areas. It doesn't have any 1-size areas.
	string freeLength = "";		// part of freeMap, containing only the lengths of the areas. It doesn't have any 1-size areas.
	...
	char last_one ;			// position of last 1-size area
